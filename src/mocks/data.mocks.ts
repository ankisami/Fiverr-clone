//models
import { Gig } from "~/models/gig.types";
import { Project } from "~/models/project.types";
import { Slider } from "~/models/slider.types";

export const categoriesMocked: Slider[] = [
  {
    id: 0,
    title: "Social Media",
  ...
  },
  {
    ...
    image:
      "https://fiverr-res.cloudinary.com/q_auto,f_auto,w_255,dpr_2.0/v1/attachments/generic_asset/asset/f27bec553efc12cc60baed89b8f2223e-1674661140708/ai-artists-2x.png",
  },
  {
    id: 7,
    title: "Logo Design",
  ...
  },
  {
    id: 8,
    title: "WordPress",
    description: "Customize your website",
    image:
